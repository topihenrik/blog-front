            ...
            <div className="header-box">
                <div className="header-top-box">
                    <div className="logo-box">
                        <button className="logo-button" onClick={() => navigate("/")}><h1>{"<Blog/>"}</h1></button>
                    </div>
                ...
                <div className={menuVis + " mobile-auth-box"}>
                    <a><button onClick={() => navigate('/login')} className="mobile-login-button">Log In</button></a>
                    <a><button onClick={() => navigate('/signup')} className="mobile-sign-up-button">Sign Up</button></a>
                </div>}
                {user?
                <div className="auth-box">
                    ...
                    <div className="auth-box">
                        <a><button onClick={() => navigate('/login')} className="login-button">Log In</button></a>
                        <a><button onClick={() => navigate('/signup')} className="sign-up-button">Sign Up</button></a>
                    </div>}
            </div>
        </header>
    )
