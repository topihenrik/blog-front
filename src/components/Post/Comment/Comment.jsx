...
export function Comment({ postid, comment, user, updateComments, setUpdateComments }) {
            ...
            <div className="comment">
                ...
                {user?._id === comment.author._id && (
                    <div className="comment-modification-buttons">
                        <button className="comment-modification-button" onClick={handleClickEdit}>
                        ...
                        <button
                            ...
                            disabled={submitDelBtnDisabled}
                            style={submitDelBtnDisabled ? { cursor: 'wait' } : {}}>
                ...
                <form className="comment-creator-form" onSubmit={handleSubmit}>
                    ...
                    <div className="comment-creator-buttons">
                        <button
                            className="comment-modification-button"
                            type="submit"
                            disabled={submitEditBtnDisabled}
                            style={submitEditBtnDisabled ? { cursor: 'wait' } : {}}>
                            <img className="icon" src={EditIcon} />
                            Update
                        </button>
                        <button
